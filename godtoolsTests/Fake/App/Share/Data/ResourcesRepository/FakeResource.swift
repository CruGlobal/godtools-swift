...
class FakeResource {
    ...
    static func createResource(resourceType: ResourceType, id: String = UUID().uuidString, attrDefaultLocale: String = "", attrCategory: String = "", attrSpotlight: Bool = false, isHidden: Bool = false) -> FakeResource {
...
extension FakeResource {
    
    func toModel() -> ResourceDataModel {
        return ResourceDataModel(id: id, abbreviation: abbreviation, attrAboutBannerAnimation: attrAboutBannerAnimation, attrAboutOverviewVideoYoutube: attrAboutOverviewVideoYoutube, attrBanner: attrBanner, attrBannerAbout: attrBannerAbout, attrCategory: attrCategory, attrDefaultLocale: attrDefaultLocale, attrDefaultOrder: attrDefaultOrder, attrSpotlight: attrSpotlight, defaultVariantId: defaultVariantId, isHidden: isHidden, manifest: manifest, metatoolId: metatoolId, name: name, oneskyProjectId: oneskyProjectId, resourceDescription: resourceDescription, resourceType: resourceType, totalViews: totalViews, type: type, attachmentIds: getAttachmentIds(), languageIds: getLanguageIds(), latestTranslationIds: getLatestTranslationIds(), variantIds: getVariantIds())
    }
}
