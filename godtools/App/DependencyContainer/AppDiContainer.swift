...
class AppDiContainer {
    ...
    init(appConfig: AppConfigInterface) {
        ...
        let toolsDiContainer = ToolsDiContainer(coreDataLayer: dataLayer, coreDomainLayer: domainLayer, personalizedToolsDataLayer: personalizedToolsDiContainer.dataLayer)
