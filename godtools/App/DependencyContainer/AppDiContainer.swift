...
class AppDiContainer {
    ...
    init(appConfig: AppConfigInterface) {
        ...
        let toolScreenShareDiContainer = ToolScreenShareFeatureDiContainer(coreDataLayer: dataLayer, coreDomainLayer: domainLayer)
        let toolScreenShareQRCodeDiContainer = ToolScreenShareQRCodeFeatureDiContainer(coreDataLayer: dataLayer, coreDomainLayer: domainLayer)
