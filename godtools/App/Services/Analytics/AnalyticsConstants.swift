...
struct AnalyticsConstants {
    struct Keys {
        ...
        static let toolAboutAction = "cru.tool_about_button"
        static let toolOpenTapAction = "cru.tool_open_tap"
        static let toolOpenedAction = "cru.tool_open_button"
        static let tutorialDismissAction = "cru.tutorial_home_dismiss"
        static let tutorialVideo = "cru.tutorial_video"
        static let tutorialVideoId = "video_id"
        static let onboardingStartAction = "cru.onboarding_start"
