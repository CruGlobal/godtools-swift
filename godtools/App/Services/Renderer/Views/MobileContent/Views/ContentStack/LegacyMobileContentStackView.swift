//
//  LegacyMobileContentStackView.swift
//  godtools
//
...
class LegacyMobileContentStackView: LegacyMobileContentView {
    ...
    private var childViews: [LegacyMobileContentView] = Array()
    private var lastAddedChildView: LegacyMobileContentView?
    private var lastAddedChildBottomConstraint: NSLayoutConstraint?
    private var autoSpacerViews: [LegacyMobileContentSpacerView] = Array()
    ...
    override func childViewDidChangeVisibilityState(childView: LegacyMobileContentView, previousVisibilityState: MobileContentViewVisibilityState, visibilityState: MobileContentViewVisibilityState) {
    ...
    private func addAutoSpacerView(spacerView: LegacyMobileContentSpacerView) {
...
extension LegacyMobileContentStackView {
...
extension LegacyMobileContentStackView {
    ...
    private func configureLayout(contentInsets: UIEdgeInsets?, scrollIsEnabled: Bool?, itemSpacing: CGFloat? = nil) {
        ...
        let currentChildViews: [LegacyMobileContentView] = childViews
        childViews = Array()
...
extension LegacyMobileContentStackView {
    ...
    func relayoutForSpacerViews() {
        ...
        for childView in childViews {
            ...
            let spacerView: LegacyMobileContentSpacerView? = childView as? LegacyMobileContentSpacerView
...
extension LegacyMobileContentStackView {
    ...
    private func addChildView(childView: LegacyMobileContentView) {
        ...
        if let accordionView = childView as? LegacyMobileContentAccordionView {
    ...
    private func addLeadingTrailingAndHeightConstraintsToChildView(childView: LegacyMobileContentView) {
        ...
        case .spacer:
            ...
            if let spacerView = childView as? LegacyMobileContentSpacerView {
                ...
                assertionFailure("Invalid view type for spacer.  View should be of type LegacyMobileContentSpacerView.")
            }
        }
    ...
    private func addTopAndBottomConstraintsToChildView(childView: LegacyMobileContentView) {
    ...
    private func addWidthAndHeightConstraintsToChildViewWithMaxWidthSizePercentageOfContainer(childView: LegacyMobileContentView, widthPercentageSizeOfContainer: CGFloat, maintainsAspectRatioSize: CGSize?) {
    ...
    private func addWidthAndHeightConstraintsToChildViewWithMaxWidthSize(childView: LegacyMobileContentView, maxWidthSize: CGFloat, maintainsAspectRatioSize: CGSize?) {
...
// MARK: - LegacyMobileContentAccordionViewDelegate

extension LegacyMobileContentStackView: LegacyMobileContentAccordionViewDelegate {
