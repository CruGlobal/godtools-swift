//
//  LegacyMobileContentMultiSelectOptionView.swift
//  godtools
//
...
class LegacyMobileContentMultiSelectOptionView: LegacyMobileContentStackView {
    ...
    init(viewModel: LegacyMobileContentMultiSelectOptionViewModel) {
        ...
        super.init(viewModel: viewModel, contentInsets: UIEdgeInsets(top: 12, left: 12, bottom: 12, right: 12), scrollIsEnabled: false)
