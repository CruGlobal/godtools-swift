//
//  LegacyMobileContentTabsView.swift
//  godtools
//
...
class LegacyMobileContentTabsView: LegacyMobileContentView, NibBased {
    ...
    override func renderChild(childView: LegacyMobileContentView) {
        ...
        if let tabView = childView as? LegacyMobileContentTabView {
...
extension LegacyMobileContentTabsView {
    
    private func addTabView(tabView: LegacyMobileContentTabView) {
    ...
    private func setSelectedTabIndex(selectedTabIndex: Int) {
        ...
        let tabView: LegacyMobileContentTabView = tabViews[selectedTabIndex]
    ...
    private func setTabContentContainerTabView(tabView: LegacyMobileContentTabView) {
