//
//  LegacyMobileContentPageCollectionView.swift
//  godtools
//
...
class LegacyMobileContentPageCollectionView: LegacyMobileContentPageView {
    ...
    init(viewModel: MobileContentPageCollectionViewModel) {
        ...
        self.pagesView = LegacyMobileContentPagesView(
...
extension LegacyMobileContentPageCollectionView: LegacyMobileContentPageViewDelegate {
