...
class LegacyMobileContentView: UIView {
    ...
    private(set) weak var parent: LegacyMobileContentView?
    
    private(set) var children: [LegacyMobileContentView] = Array()
    ...
    private func getRootView() -> LegacyMobileContentView {
        
        if let parentView = parent {
            
            var rootView: LegacyMobileContentView = parentView
            var nextParentView: LegacyMobileContentView? = parentView.parent
    ...
    func setParentAndAddChild(childView: LegacyMobileContentView) {
    ...
    func renderChild(childView: LegacyMobileContentView) {
    ...
    func childViewDidChangeVisibilityState(childView: LegacyMobileContentView, previousVisibilityState: MobileContentViewVisibilityState, visibilityState: MobileContentViewVisibilityState) {
    ...
    private func recurseViewDidAppear(view: LegacyMobileContentView, navigationEvent: MobileContentPagesNavigationEvent?) {
    ...
    private func recurseViewDidDisappear(view: LegacyMobileContentView) {
        for childView in view.children {
    ...
    private func walkUpHierarchyAndSendEventsToEachAncestor(view: LegacyMobileContentView, eventIds: inout [EventId]) {
    ...
    private func recurseChildrenAndSendEventsFromView(view: LegacyMobileContentView, eventIds: inout [EventId], eventTrigger: EventTriggerType) {
    ...
    private func sendEventsToView(view: LegacyMobileContentView, eventIds: inout [EventId], eventTrigger: EventTriggerType) {
    ...
    private func recurseHierarchyAndGetPositionState(view: LegacyMobileContentView, viewPositionState: MobileContentViewPositionState) {
    ...
    private func recurseHierarchyAndSetPositionState(view: LegacyMobileContentView, viewPositionState: MobileContentViewPositionState, animated: Bool) {
        ...
        for index in 0 ..< viewPositionState.children.count {
            ...
            let childView: LegacyMobileContentView = view.children[index]
