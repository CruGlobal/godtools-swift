//
//  LegacyMobileContentPagesView.swift
//  godtools
//
...
class LegacyMobileContentPagesView: AppViewController {
    ...
    init(
        ...
        super.init(nibName: String(describing: LegacyMobileContentPagesView.self), bundle: nil, navigationBar: navigationBar)
    }
    ...
    func setupBinding() {
        ...
        viewModel.pageNavigationEventSignal.addObserver(self) { [weak self] (navigationEvent: MobileContentPagesNavigationEvent) in
            ...
            weakSelf.pageNavigationView.scrollToPage(pageNavigation: navigationEvent.pageNavigation, completion: { (completedNavigation: PageNavigationCollectionViewNavigationCompleted) in
                ...
                let pageView: LegacyMobileContentPageView? = pageCell?.mobileContentView as? LegacyMobileContentPageView
    ...
    func setPageViewDelegate(pageViewDelegate: LegacyMobileContentPageViewDelegate?) {

        self.pageViewDelegate = pageViewDelegate
    }
    
    func didConfigurePageView(pageView: LegacyMobileContentPageView) {
    ...
    private func getAllVisiblePagesPositions() -> [PageNumber: MobileContentViewPositionState] {
        ...
        for cell in visiblePageCells {
            ...
            if let pageCell = cell as? MobileContentPageCell, let pageView = pageCell.mobileContentView as? LegacyMobileContentPageView, let indexPath = pageNavigationView.getIndexPathForPageCell(pageCell: pageCell) {
    ...
    func getPagePositions(page: Int) -> MobileContentViewPositionState? {
        ...
        guard let pageView = pageCell.mobileContentView as? LegacyMobileContentPageView else {
            return nil
        }
...
extension LegacyMobileContentPagesView: PageNavigationCollectionViewDelegate {
    ...
    func pageNavigation(pageNavigation: PageNavigationCollectionView, cellForPageAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let pageView = viewModel.pageWillAppear(page: pageNumber, pageParams: pageParams) as? LegacyMobileContentPageView else {
            assertionFailure("Provided LegacyMobileContentView should inherit from LegacyMobileContentPageView")
            return UICollectionViewCell()
        }
    ...
    func pageNavigationPageDidAppear(pageNavigation: PageNavigationCollectionView, pageCell: UICollectionViewCell, page: Int) {
        ...
        if let contentPageCell = pageCell as? MobileContentPageCell {
            ...
            if let pageView = contentPageCell.mobileContentView as? LegacyMobileContentPageView, let pagePositions = initialPagePositions[page] {
...
// MARK: - LegacyMobileContentPageViewDelegate

extension LegacyMobileContentPagesView: LegacyMobileContentPageViewDelegate {
    
    func pageViewDidReceiveEvent(pageView: LegacyMobileContentPageView, eventId: EventId) -> ProcessedEventResult? {
