//
//  LegacyMobileContentEmbeddedVideoView.swift
//  godtools
//
...
class LegacyMobileContentEmbeddedVideoView: LegacyMobileContentView {
    ...
    private func setLoadingViewHidden(hidden: Bool, animated: Bool) {
        ...
        let videoView: LegacyMobileContentEmbeddedVideoView = self
...
extension LegacyMobileContentEmbeddedVideoView: YTPlayerViewDelegate {
