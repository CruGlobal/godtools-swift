//
//  LegacyMobileContentTabViewModel.swift
//  godtools
//
...
class LegacyMobileContentTabViewModel: LegacyMobileContentViewModel {
...
extension LegacyMobileContentTabViewModel {
    ...
    func tabTapped() {
        ...
        Task {
            ...
            try await mobileContentAnalytics.trackEvents(
                events: tabModel.getAnalyticsEvents(type: .clicked),
