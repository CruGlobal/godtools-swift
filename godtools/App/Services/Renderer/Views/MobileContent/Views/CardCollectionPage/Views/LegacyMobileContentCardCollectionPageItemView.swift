//
//  LegacyMobileContentCardCollectionPageItemView.swift
//  godtools
//
...
class LegacyMobileContentCardCollectionPageItemView: UICollectionViewCell {
    
    static let nibName: String = "LegacyMobileContentCardCollectionPageItemView"
    ...
    private var cardView: LegacyMobileContentCardCollectionPageCardView?
    ...
    func configure(cardView: LegacyMobileContentCardCollectionPageCardView) {
