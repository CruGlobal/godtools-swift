//
//  LegacyMobileContentCardCollectionPageView.swift
//  godtools
//
...
class LegacyMobileContentCardCollectionPageView: LegacyMobileContentPageView {
    ...
    override func setupLayout() {
        ...
        cardPageNavigationView.registerPageCell(classClass: LegacyMobileContentCardCollectionPageItemView.self, cellReuseIdentifier: LegacyMobileContentCardCollectionPageItemView.reuseIdentifier)
...
extension LegacyMobileContentCardCollectionPageView: PageNavigationCollectionViewDelegate {
    ...
    func pageNavigation(pageNavigation: PageNavigationCollectionView, cellForPageAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = cardPageNavigationView.getReusablePageCell(
            cellReuseIdentifier: LegacyMobileContentCardCollectionPageItemView.reuseIdentifier,
            indexPath: indexPath) as? LegacyMobileContentCardCollectionPageItemView else {
            
            assertionFailure("Failed to dequeue reusable cell with identifier :\(LegacyMobileContentCardCollectionPageItemView.reuseIdentifier)")
            
            return UICollectionViewCell()
        }
        
        if let cardView = viewModel.cardWillAppear(card: indexPath.row) as? LegacyMobileContentCardCollectionPageCardView {
            cell.configure(cardView: cardView)
        }
        else {
            assertionFailure("Failed to render LegacyMobileContentCardCollectionPageCardView.")
        }
