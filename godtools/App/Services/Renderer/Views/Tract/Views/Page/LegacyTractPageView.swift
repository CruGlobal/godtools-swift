...
@MainActor
protocol LegacyTractPageViewDelegate: AnyObject {
...
class LegacyTractPageView: LegacyMobileContentPageView {
    ...
    private var headerView: LegacyTractPageHeaderView?
    private var heroView: LegacyTractPageHeroView?
    private var callToActionView: LegacyTractPageCallToActionView?
    private var cardsView: LegacyTractPageCardsView?
    private var bottomView: UIView?
    
    private weak var delegate: LegacyTractPageViewDelegate?
    ...
    init(viewModel: LegacyTractPageViewModel, safeArea: UIEdgeInsets) {
        ...
        super.init(viewModel: viewModel, nibName: String(describing: LegacyTractPageView.self))
    ...
    override func renderChild(childView: LegacyMobileContentView) {
        ...
        if let headerView = childView as? LegacyTractPageHeaderView {
            addHeaderView(headerView: headerView)
        }
        else if let callToActionView = childView as? LegacyTractPageCallToActionView {
            addCallToActionView(callToActionView: callToActionView)
        }
        else if let heroView = childView as? LegacyTractPageHeroView {
            addHeroView(heroView: heroView)
        }
        else if let cardsView = childView as? LegacyTractPageCardsView {
    ...
    func setTractPageDelegate(delegate: LegacyTractPageViewDelegate?) {
...
extension LegacyTractPageView {
    
    private func addHeaderView(headerView: LegacyTractPageHeaderView) {
...
extension LegacyTractPageView {
    ...
    private func addHeroView(heroView: LegacyTractPageHeroView) {
...
// MARK: - Call To Action, LegacyTractPageCallToActionViewDelegate

extension LegacyTractPageView: LegacyTractPageCallToActionViewDelegate {
    
    private func addCallToActionView(callToActionView: LegacyTractPageCallToActionView) {
...
// MARK: - LegacyTractPageCardsViewDelegate

extension LegacyTractPageView: LegacyTractPageCardsViewDelegate {
...
extension LegacyTractPageView: UIGestureRecognizerDelegate {
