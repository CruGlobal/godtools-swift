//
//  LegacyTractPageFormViewModel.swift
//  godtools
//
...
class LegacyTractPageFormViewModel: LegacyMobileContentFormViewModel {
        
    private let followUpService: FollowUpsService
    private let localizationServices: LocalizationServicesInterface
    
    let didSendFollowUpSignal: SignalValue<[EventId]> = SignalValue()
    let error: ObservableValue<LegacyMobileContentErrorViewModel?> = ObservableValue(value: nil)
    ...
    private func notifiyFollowUpsMissingFieldsError(missingFieldsNames: [String]) {
        ...
        let errorViewModel = LegacyMobileContentErrorViewModel(
            title: errorTitle,
