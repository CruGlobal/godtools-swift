//
//  LegacyTractPageCardsView.swift
//  godtools
//
...
@MainActor
protocol LegacyTractPageCardsViewDelegate: AnyObject {
    
    func tractPageCardsDidChangeCardState(cardsView: LegacyTractPageCardsView, cardsState: TractPageCardsState, animated: Bool)
    func tractPageCardsDidChangeCardPosition(cardsView: LegacyTractPageCardsView, cardPosition: Int?, animated: Bool)
}
...
class LegacyTractPageCardsView: LegacyMobileContentView {
    ...
    private var allCards: [LegacyTractPageCardView] = Array()
    private var renderedCards: [LegacyTractPageCardView] = Array()
    ...
    private func addCardJumpObserving() {
        ...
        viewModel.$showsCardJump
            .sink { [weak self] (showsCardJump: Bool) in
                ...
                let firstCard: LegacyTractPageCardView? = weakSelf.renderedCards.first
    ...
    override func renderChild(childView: LegacyMobileContentView) {
        ...
        if let cardView = childView as? LegacyTractPageCardView {
    ...
    func setCardsViewDelegate(delegate: LegacyTractPageCardsViewDelegate) {
        self.delegate = delegate
    }
    
    private func dismissCard(cardView: LegacyTractPageCardView) {
    ...
    private func presentCard(cardView: LegacyTractPageCardView) {
...
extension LegacyTractPageCardsView: KeyboardNotificationObserverDelegate {
...
extension LegacyTractPageCardsView: TractPageCardBounceAnimationDelegate {
...
// MARK: - LegacyTractPageCardViewDelegate

extension LegacyTractPageCardsView: LegacyTractPageCardViewDelegate {
...
extension LegacyTractPageCardsView {
    ...
    private var showCardBottomInset: CGFloat {
        ...
        let cardTopVisibilityHeight: CGFloat = floor(LegacyTractPageCardView.minimumCardHeaderHeight * cardCollapsedVisibilityPercentage)
    ...
    private func addCardToRenderedCards(cardView: LegacyTractPageCardView) {
    ...
    private func removeHiddenCardFromRenderedCards(cardView: LegacyTractPageCardView, animated: Bool) {
    ...
    private func removeRenderedCard(cardView: LegacyTractPageCardView, shouldRemoveFromView: Bool) {
    ...
    private func getRenderedCardPosition(cardView: LegacyTractPageCardView) -> Int? {
        return renderedCards.firstIndex(of: cardView)
    }
    
    private func getRenderedCardView(cardPosition: Int) -> LegacyTractPageCardView? {
