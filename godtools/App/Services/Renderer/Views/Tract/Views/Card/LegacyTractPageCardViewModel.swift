//
//  LegacyTractPageCardViewModel.swift
//  godtools
//
...
class LegacyTractPageCardViewModel: LegacyMobileContentViewModel {
...
extension LegacyTractPageCardViewModel {
    
    func backgroundImageWillAppear() -> LegacyMobileContentBackgroundImageViewModel? {
