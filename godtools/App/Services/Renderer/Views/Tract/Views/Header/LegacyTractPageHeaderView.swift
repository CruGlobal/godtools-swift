//
//  LegacyTractPageHeaderView.swift
//  godtools
//
...
class LegacyTractPageHeaderView: LegacyMobileContentView, NibBased {
    
    private let numberLabelWidthForHiddenState: CGFloat = 50
    private let trainingTipLeadingToTitleForNumberHiddenState: CGFloat = 5
    
    private var numberTextView: LegacyMobileContentTextView?
    private var titleTextView: LegacyMobileContentTextView?
    private var trainingTipView: LegacyTrainingTipView?
    ...
    override func renderChild(childView: LegacyMobileContentView) {
        ...
        if let trainingTipView = childView as? LegacyTrainingTipView {
