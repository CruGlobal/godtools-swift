//
//  LegacyTractPageModalsView.swift
//  godtools
//
...
class LegacyTractPageModalsView: LegacyMobileContentView {
    ...
    override func renderChild(childView: LegacyMobileContentView) {
        ...
        if let modalView = childView as? LegacyTractPageModalView {
    ...
    private func presentModalView(modalView: LegacyTractPageModalView, animated: Bool) {
...
// MARK: - LegacyTractPageModalViewDelegate

extension LegacyTractPageModalsView: LegacyTractPageModalViewDelegate {
    
    func tractPageModalListenerActivated(modalView: LegacyTractPageModalView) {
        presentModalView(modalView: modalView, animated: true)
    }
    
    func tractPageModalDismissListenerActivated(modalView: LegacyTractPageModalView) {
