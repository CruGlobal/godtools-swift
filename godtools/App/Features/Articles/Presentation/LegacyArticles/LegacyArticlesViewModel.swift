...
@MainActor
final class LegacyArticlesViewModel: NSObject {
...
extension LegacyArticlesViewModel {
    ...
    func articleWillAppear(index: Int) -> LegacyArticleCellViewModel {
        
        let aemCacheObject: ArticleAemCacheObject = articleAemCacheObjects[index]
        
        return LegacyArticleCellViewModel(aemData: aemCacheObject.aemData)
    }
