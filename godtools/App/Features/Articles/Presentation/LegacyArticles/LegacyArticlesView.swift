...
class LegacyArticlesView: AppViewController {
    
    private let viewModel: LegacyArticlesViewModel
    ...
    init(viewModel: LegacyArticlesViewModel, navigationBar: AppNavigationBar?) {
        
        self.viewModel = viewModel
        
        super.init(nibName: String(describing: LegacyArticlesView.self), bundle: nil, navigationBar: navigationBar)
    }
    ...
    private func setupLayout() {
        ...
        articlesTableView.register(
            UINib(nibName: LegacyArticleCell.nibName, bundle: nil),
            forCellReuseIdentifier: LegacyArticleCell.reuseIdentifier
        )
...
extension LegacyArticlesView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell: LegacyArticleCell = articlesTableView.dequeueReusableCell(
            withIdentifier: LegacyArticleCell.reuseIdentifier,
            for: indexPath) as? LegacyArticleCell else {
            
            assertionFailure("Failed to dequeue reusable cell with identifier :\(LegacyArticleCell.reuseIdentifier)")
...
extension LegacyArticlesView: ArticlesErrorMessageViewDelegate {
