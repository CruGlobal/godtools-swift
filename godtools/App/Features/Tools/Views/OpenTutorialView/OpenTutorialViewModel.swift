...
class OpenTutorialViewModel: NSObject, OpenTutorialViewModelType {
    ...
    func closeTapped() {
        openTutorialCalloutCache.disableOpenTutorialCallout()
        analytics.trackActionAnalytics.trackAction(trackAction: TrackActionModel(screenName: "home", actionName: "Tutorial Home Dismiss", siteSection: nil, siteSubSection: nil, url: nil, data: ["cru.tutorial_home_dismiss": 1]))
    }
}
