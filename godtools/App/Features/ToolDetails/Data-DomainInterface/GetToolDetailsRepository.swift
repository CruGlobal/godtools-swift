...
class GetToolDetailsRepository: GetToolDetailsRepositoryInterface {
    ...
    func getDetailsPublisher(tool: ToolDomainModel, translateInToolLanguage: String) -> AnyPublisher<ToolDetailsDomainModel, Never> {
        ...
        let languageNamesTranslatedInToolLanguage: [String] = languagesDataModels.compactMap { (languageDataModel: LanguageModel) in
            ...
            guard let languageDisplayName = self.localeLanguageName.getDisplayName(forLanguageId: languageDataModel.code, translatedInLanguageId: translateInToolLanguage) else {
                return nil
            }
        ...
        let toolLanguageName: String? = localeLanguageName.getDisplayName(forLanguageId: translateInToolLanguage, translatedInLanguageId: translateInToolLanguage)
