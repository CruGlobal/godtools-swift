...
class DashboardViewModel: ObservableObject {
    ...
    init(
        ...
        viewDashboardUseCase: ViewDashboardUseCase,
        dashboardTabObserver: CurrentValueSubject<
        ...
        $appLanguage
            ...
            .sink { [weak self] (domainModel: ViewDashboardDomainModel) in
                ...
                self?.lessonsButtonTitle =
                    domainModel.interfaceStrings.lessonsActionTitle
                self?.favoritesButtonTitle =
                    domainModel.interfaceStrings.favoritesActionTitle
                self?.toolsButtonTitle =
                    domainModel.interfaceStrings.toolsActionTitle
    ...
    private func setStartingTabIfNeeded(
        startingTab: DashboardTabTypeDomainModel,
        tabs: [DashboardTabTypeDomainModel]
    ) {
