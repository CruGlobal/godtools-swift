...
class SwiftUIPreviewDatabase: RealmDatabase {
    ...
    override init(databaseConfiguration: RealmDatabaseConfiguration, shouldUseSingleRealmInstance: Bool = false) {
        
        super.init(databaseConfiguration: databaseConfiguration, shouldUseSingleRealmInstance: shouldUseSingleRealmInstance)
