...
class AppFlow: NSObject, ToolNavigationFlow, Flow {
    ...
    private static let defaultStartingDashboardTab:
        DashboardTabTypeDomainModel = .favorites
    ...
    private let dashboardTabObserver = CurrentValueSubject<
        DashboardTabTypeDomainModel, Never
    >(AppFlow.defaultStartingDashboardTab)
    ...
    init(
        ...
        appDeepLinkingService: DeepLinkingService
    ) {
        ...
        self.toolLanguageDownloader = appDiContainer.feature.appLanguage
            .dataLayer.getToolLanguageDownloader()
        self.followUpsService = appDiContainer.dataLayer.getFollowUpsService()
        self.resourceViewsService = appDiContainer.dataLayer
            .getResourceViewsService()
    ...
    func navigate(step: FlowStep) {
        ...
        case .appLaunchedFromTerminatedState:
            ...
            appDiContainer.feature.onboarding.domainLayer
                .getOnboardingTutorialIsAvailableUseCase()
                .getAvailablePublisher()
                .receive(on: DispatchQueue.main)
                .first()
                .sink(receiveValue: {
                    [weak self] (onboardingTutorialIsAvailable: Bool) in
        ...
        case .appLaunchedFromBackgroundState:
            ...
            let elapsedTimeInSeconds: TimeInterval =
                currentDate.timeIntervalSince(resignedActiveDate)
        ...
        case .lessonFlowCompleted(let state):
            ...
            case .userClosedLesson(let lessonId, let highestPageNumberViewed):
                ...
                let getLessonEvaluatedUseCase: GetLessonEvaluatedUseCase =
                    appDiContainer.feature.lessonEvaluation.domainLayer
                    .getLessonEvaluatedUseCase()

                getLessonEvaluatedUseCase.getEvaluatedPublisher(
                    lessonId: lessonId
                )
                .receive(on: DispatchQueue.main)
        ...
        case .chooseYourOwnAdventureFlowCompleted(let state):
            ...
            case .userClosedTool:
                ...
                if let dashboardInNavigationStack =
                    getDashboardInNavigationStack()
                {
...
extension AppFlow {
    ...
    private func launchAppFromTerminatedState(
        onboardingTutorialIsAvailable: Bool
    ) {
    ...
    private func loadInitialData() {
        ...
        resourcesRepository
            ...
            .flatMap({
                (result: RealmResourcesCacheSyncResult) -> AnyPublisher<
                    Void, Error
                > in
        ...
        let authenticateUser: AuthenticateUserInterface = appDiContainer.feature
            .account.dataLayer.getAuthenticateUserInterface()
    ...
    private func countAppSessionLaunch() {
        ...
        let incrementUserCounterUseCase = appDiContainer.domainLayer
            .getIncrementUserCounterUseCase()
...
extension AppFlow {
    ...
    private func getDashboardInNavigationStack() -> AppHostingController<
        DashboardView
    >? {

        for viewController in navigationController.viewControllers {
            if let dashboardView = viewController
                as? AppHostingController<DashboardView>
            {
        ...
        -> UIViewController
    {
        ...
        let menuButton = AppMenuBarItem(
            ...
            accessibilityIdentifier: AccessibilityStrings.Button.dashboardMenu
                .id
        )
...
extension AppFlow {
    ...
    private func addDeepLinkingObservers() {
        ...
        deepLinkingService.deepLinkObserver.addObserver(self) {
            [weak self] (optionalDeepLink: ParsedDeepLinkType?) in
    ...
    private func navigateToDeepLink(deepLink: ParsedDeepLinkType) {
            ...
            navigateToDashboard(
                ...
                didCompleteDismissingPresentedView: { [weak self] in
                    ...
                    let articleDeepLinkFlow = ArticleDeepLinkFlow(
                        ...
                        sharedNavigationController: weakSelf
        ...
        case .onboarding(let appLanguage):
            ...
            let userAppLanguageRepository: UserAppLanguageRepository =
                appDiContainer.feature.appLanguage.dataLayer
                .getUserAppLanguageRepository()

            userAppLanguageRepository.storeLanguagePublisher(
...
extension AppFlow {
    ...
    private func navigateToToolWithUserToolLanguageSettingsApplied(
        ...
        let userToolSettingsRepository: UserToolSettingsRepository =
            appDiContainer.feature.persistFavoritedToolLanguageSettings
            .dataLayer.getUserToolSettingsRepository()
...
extension AppFlow {
    ...
    func getAllFavoriteTools() -> UIViewController {
        ...
        let viewModel = AllYourFavoriteToolsViewModel(
            flowDelegate: self,
            viewAllYourFavoritedToolsUseCase: appDiContainer.feature.favorites
                .domainLayer.getViewAllYourFavoritedToolsUseCase(),
            getCurrentAppLanguageUseCase: appDiContainer.feature.appLanguage
                .domainLayer.getCurrentAppLanguageUseCase(),
...
extension AppFlow {
    ...
    private func getToolCategoryFilterSelection() -> UIViewController {
        ...
        let viewModel = ToolFilterCategorySelectionViewModel(
            viewToolFilterCategoriesUseCase: appDiContainer.feature.toolsFilter
                .domainLayer.getViewToolFilterCategoriesUseCase(),
            searchToolFilterCategoriesUseCase: appDiContainer.feature
                .toolsFilter.domainLayer.getSearchToolFilterCategoriesUseCase(),
            getUserToolFiltersUseCase: appDiContainer.feature.toolsFilter
                .domainLayer.getUserToolFiltersUseCase(),
            storeUserToolFiltersUseCase: appDiContainer.feature.toolsFilter
                .domainLayer.getStoreUserToolFiltersUseCase(),
            getCurrentAppLanguageUseCase: appDiContainer.feature.appLanguage
                .domainLayer.getCurrentAppLanguageUseCase(),
            viewSearchBarUseCase: appDiContainer.domainLayer
                .getViewSearchBarUseCase(),
            flowDelegate: self
        )
    ...
    private func getToolLanguageFilterSelection() -> UIViewController {
        ...
        let viewModel = ToolFilterLanguageSelectionViewModel(
            viewToolFilterLanguagesUseCase: appDiContainer.feature.toolsFilter
                .domainLayer.getViewToolFilterLanguagesUseCase(),
            searchToolFilterLanguagesUseCase: appDiContainer.feature.toolsFilter
                .domainLayer.getSearchToolFilterLanguagesUseCase(),
            getUserToolFiltersUseCase: appDiContainer.feature.toolsFilter
                .domainLayer.getUserToolFiltersUseCase(),
            storeUserToolFilterUseCase: appDiContainer.feature.toolsFilter
                .domainLayer.getStoreUserToolFiltersUseCase(),
            getCurrentAppLanguageUseCase: appDiContainer.feature.appLanguage
                .domainLayer.getCurrentAppLanguageUseCase(),
            viewSearchBarUseCase: appDiContainer.domainLayer
...
extension AppFlow {
    ...
    private func getToolDetails(
        ...
        let viewModel = ToolDetailsViewModel(
            ...
            getCurrentAppLanguageUseCase: appDiContainer.feature.appLanguage
                .domainLayer.getCurrentAppLanguageUseCase(),
            viewToolDetailsUseCase: appDiContainer.feature.toolDetails
                .domainLayer.getViewToolDetailsUseCase(),
            getToolDetailsMediaUseCase: appDiContainer.feature.toolDetails
                .domainLayer.getToolDetailsMediaUseCase(),
            getToolDetailsLearnToShareToolIsAvailableUseCase: appDiContainer
                .feature.toolDetails.domainLayer
        ...
        let backButton = AppBackBarItem(
            target: viewModel,
            action: #selector(viewModel.backTapped),
            accessibilityIdentifier: AccessibilityStrings.Button
                .toolDetailsNavBack.id
        )
...
extension AppFlow {
    ...
    private func navigateToLearnToShareTool(
        ...
        let toolTrainingTipsOnboardingViews:
            ToolTrainingTipsOnboardingViewsService =
                appDiContainer.getToolTrainingTipsOnboardingViews()
...
extension AppFlow {
    ...
    private func getLessonLanguageFilterSelection() -> UIViewController {
        ...
        let viewModel = LessonFilterLanguageSelectionViewModel(
            viewLessonFilterLanguagesUseCase: appDiContainer.feature
                .lessonFilter.domainLayer.getViewLessonFilterLanguagesUseCase(),
            getUserLessonFiltersUseCase: appDiContainer.feature.lessonFilter
                .domainLayer.getUserLessonFiltersUseCase(),
            storeUserLessonFiltersUseCase: appDiContainer.feature.lessonFilter
                .domainLayer.getStoreUserLessonFiltersUseCase(),
            viewSearchBarUseCase: appDiContainer.domainLayer
                .getViewSearchBarUseCase(),
            searchLessonFilterLanguagesUseCase: appDiContainer.feature
                .lessonFilter.domainLayer
                .getSearchLessonFilterLanguagesUseCase(),
            getCurrentAppLanguageUseCase: appDiContainer.feature.appLanguage
                .domainLayer.getCurrentAppLanguageUseCase(),
            flowDelegate: self
        )
        ...
        let hostingView = AppHostingController<
            LessonFilterLanguageSelectionView
        >(
            rootView: view,
            navigationBar: AppNavigationBar(
                appearance: nil,
...
extension AppFlow {
    ...
    private func presentLessonEvaluation(
        ...
        let viewModel = LessonEvaluationViewModel(
            ...
            getCurrentAppLanguageUseCase: appDiContainer.feature.appLanguage
                .domainLayer.getCurrentAppLanguageUseCase(),
            getLessonEvaluationInterfaceStringsUseCase: appDiContainer.feature
                .lessonEvaluation.domainLayer
                .getLessonEvaluationInterfaceStringsUseCase(),
            didChangeScaleForSpiritualConversationReadinessUseCase:
                appDiContainer.feature.lessonEvaluation.domainLayer
                .getDidChangeScaleForSpiritualConversationReadinessUseCase(),
            evaluateLessonUseCase: appDiContainer.feature.lessonEvaluation
                .domainLayer.getEvaluateLessonUseCase(),
            cancelLessonEvaluationUseCase: appDiContainer.feature
                .lessonEvaluation.domainLayer.getCancelLessonEvaluationUseCase()
        )
    ...
    @objc private func handleUIApplicationLifeCycleNotification(
        ...
        } else if notification.name == UIApplication.didBecomeActiveNotification
        {
            ...
            let appLaunchedFromBackgroundState: Bool =
                navigationStarted && appIsInBackground
