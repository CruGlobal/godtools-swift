...
final class MenuFlow: GTFlow {
    ...
    override func navigate(step: FlowStep) {
        ...
        case .copyFirebaseDeviceTokenTappedFromMenu:
            if appDiContainer.core.dataLayer.getAppBuild().isDebug {
...
extension MenuFlow {
    ...
    private func getMenuView(appLanguage: AppLanguageDomainModel) -> UIViewController {
        ...
        let viewModel = MenuViewModel(
            ...
            appBuild: appDiContainer.core.dataLayer.getAppBuild()
        )
...
extension MenuFlow {
    ...
    private func getAccountView() -> UIViewController {
        ...
        let viewModel = AccountViewModel(
            ...
            globalAnalyticsSync: appDiContainer.feature.globalActivity.dataLayer.getGlobalAnalyticsSync(),
