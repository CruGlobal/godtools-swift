...
extension ResourcesCache {
    ...
    @MainActor func getLessonsPublisher(filterByLanguageId: String? = nil, sorted: Bool = false) -> AnyPublisher<[ResourceDataModel], Error> {
    ...
    @MainActor func getFeaturedLessonsPublisher(sorted: Bool = false) -> AnyPublisher<[ResourceDataModel], Error> {
...
extension ResourcesCache {
    ...
    @MainActor func getResourceVariantsPublisher(resourceId: String) -> AnyPublisher<[ResourceDataModel], Error> {
    ...
    @MainActor func getResourcesPublisher(sorted: Bool = false) -> AnyPublisher<[ResourceDataModel], Error> {
