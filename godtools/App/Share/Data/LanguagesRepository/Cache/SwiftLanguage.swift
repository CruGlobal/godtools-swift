...
extension SwiftLanguage {
    ...
    public static func idPredicate(id: String) -> Predicate<SwiftLanguage> {
        return #Predicate<SwiftLanguage> { object in
            object.id == id
        }
    }

    public static func idsPredicate(ids: Set<String>) -> Predicate<SwiftLanguage> {
        return #Predicate<SwiftLanguage> { object in
