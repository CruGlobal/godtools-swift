...
extension TrackDownloadedTranslationsCache {
    ...
    @MainActor func getLatestDownloadedTranslationsPublisher(resourceId: String, languageId: String) -> AnyPublisher<[DownloadedTranslationDataModel], Error> {
    ...
    @MainActor func getLatestDownloadedTranslation(resourceId: String, languageId: String) -> DownloadedTranslationDataModel? {
