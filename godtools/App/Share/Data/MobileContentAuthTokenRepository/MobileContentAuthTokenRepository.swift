...
class MobileContentAuthTokenRepository {
    ...
    func fetchRemoteAuthTokenPublisher(authToken: MobileContentAuthToken, createUser: Bool) -> AnyPublisher<MobileContentAuthTokenDataModel, URLResponseError> {
        
        return api.fetchAuthTokenPublisher(authToken: authToken, createUser: createUser)
