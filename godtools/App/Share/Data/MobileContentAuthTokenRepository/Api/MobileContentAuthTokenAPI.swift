...
class MobileContentAuthTokenAPI {
    ...
    private func getAuthTokenRequest(authToken: MobileContentAuthToken, createUser: Bool) -> URLRequest {
    ...
    func fetchAuthTokenPublisher(authToken: MobileContentAuthToken, createUser: Bool) -> AnyPublisher<MobileContentAuthTokenDecodable, URLResponseError> {
        
        return session.dataTaskPublisher(for: getAuthTokenRequest(authToken: authToken, createUser: createUser))
            .tryMap {
