...
struct PagedView<Content: View>: View {
    ...
    init(layoutDirection: LayoutDirection = ApplicationLayout.shared.layoutDirection, numberOfPages: Int, currentPage: Binding<Int>, @ViewBuilder content: @escaping (_ page: Int) -> Content) {
