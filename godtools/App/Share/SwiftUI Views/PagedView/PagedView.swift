...
struct PagedView<Content: View>: View {
    ...
    init(layoutDirection: LayoutDirection = ApplicationLayout.direction.swiftUI, numberOfPages: Int, currentPage: Binding<Int>, @ViewBuilder content: @escaping (_ page: Int) -> Content) {
