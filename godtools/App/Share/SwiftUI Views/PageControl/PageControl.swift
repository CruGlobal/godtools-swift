...
struct PageControl: View {
    ...
    init(layoutDirection: LayoutDirection = ApplicationLayout.direction.swiftUI, numberOfPages: Int, attributes: PageControlAttributesType, currentPage: Binding<Int>) {
