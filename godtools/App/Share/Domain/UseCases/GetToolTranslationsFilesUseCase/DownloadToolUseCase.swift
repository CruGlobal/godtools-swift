    ...
    func execute(
        ...
        do {
            ...
            case .failedToFetchResourceFromCache(let resourceNeeded):
                ...
                guard downloadType == .cacheElseRemote else {
                    return nil
                }
