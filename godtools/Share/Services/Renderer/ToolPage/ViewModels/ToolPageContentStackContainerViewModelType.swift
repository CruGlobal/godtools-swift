...
protocol ToolPageContentStackContainerViewModelType: MobileContentViewModelType {
    
    var contentRenderer: ToolPageContentRenderer { get }
    var content: ToolPageRenderedContent? { get }
